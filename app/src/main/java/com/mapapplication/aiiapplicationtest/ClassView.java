...
// Draw the display text
        canvas.drawText(display, displayTextX-150, displayTextY-200, textPaint);


        shortestPath(h,t,canvas);
    }
//        if (onlytarget)
//            shortestPath(h, t,canvas);
    ...
    private static final float MAX_PERCENTAGE_OUT_OF_BOUNDS = 0.3f; // 10% out of bounds
