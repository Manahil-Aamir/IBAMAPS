...
public class StartActivity extends AppCompatActivity {
    ...
    public MyGraph TGraph;
    public String targetword;
    Boolean TisBuilding = false;
    Boolean HisBuilding = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("target",targetword);

            //     intent.putExtra("TargetGraph",  a.g);
    ...
    public aStar finding(String h, String t) {
        ...
        if (h.equalsIgnoreCase("AMANCED") || h.equalsIgnoreCase("TABBAACADEMICBLOCK") || h.equalsIgnoreCase("ADAMJEEACADEMICBLOCK") ||
                ...
                || h.equalsIgnoreCase("MARTINDOW") || h.equalsIgnoreCase("GATE2") || h.equalsIgnoreCase("GATE4") || h.equalsIgnoreCase("G&TAUDITORIUM")) { //HisBuilding=true;
        } else {
            if (h.equalsIgnoreCase("MTS6") || h.equalsIgnoreCase("SEMINARROOM6") || h.equalsIgnoreCase("BREAKOUT1") ||
                    ...
                    h.equalsIgnoreCase("PHDSCHOLARS") || h.equalsIgnoreCase("MTC20A") || h.equalsIgnoreCase("MTC17") || h.equalsIgnoreCase("MTC18") || h.equalsIgnoreCase("MTC19") || h.equalsIgnoreCase("MTC20") || h.equalsIgnoreCase("MTC20-A") ||
        ...
        if(tword!="" ){
            aStar targetclass=new aStar(head,target,new classroom(tword));
            targetword=tword;
        }
